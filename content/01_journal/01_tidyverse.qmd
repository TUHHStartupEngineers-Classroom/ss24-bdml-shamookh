...
kmeans_mapped_tbl %>%
    ...
    geom_line(color = "green", size = 1) + labs(title = "K-means Tot. Withinss vs Centers", x = "Centers", y = "Total Within-Cluster Sum of Squares") +
  theme_minimal(base_family = "Times") +  # Use a font that represents Roman style
  theme(
    plot.title = element_text(face = "bold", family = "Times", size = 14),
...
umap_kmeans_results_tbl %>%
  ...
  geom_point(alpha = 0.5) + theme_minimal(base_family = "Times") +  # Use a font that represents Roman style
  theme(
    plot.title = element_text(face = "bold", family = "Times", size = 14),
    axis.title = element_text(face = "bold", family = "Times", size = 12),
    axis.text = element_text(family = "Times", size = 10)
