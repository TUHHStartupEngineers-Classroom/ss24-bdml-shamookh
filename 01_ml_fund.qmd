...
__My second challange does not appear on my journal for some reason, but it is present on my github folder in the proper folder, same name as I got it. I have no idea why can I not make the changed version appear online. On my laptom when I build the website, the solved challange appears.__
# Challenge Summary
